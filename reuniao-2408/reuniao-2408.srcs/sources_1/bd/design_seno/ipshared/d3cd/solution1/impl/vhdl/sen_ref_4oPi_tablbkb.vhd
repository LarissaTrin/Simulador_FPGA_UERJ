...
entity sen_ref_4oPi_tablbkb_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of sen_ref_4oPi_tablbkb_rom is 
...
entity sen_ref_4oPi_tablbkb is
    generic (
...
architecture arch of sen_ref_4oPi_tablbkb is
    component sen_ref_4oPi_tablbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sen_ref_4oPi_tablbkb_rom_U :  component sen_ref_4oPi_tablbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
