...
// ==============================================================
#ifndef __sen_mul_mul_15ns_hbi__HH__
#define __sen_mul_mul_15ns_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sen_mul_mul_15ns_hbi) {
    ...
    SC_CTOR(sen_mul_mul_15ns_hbi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
