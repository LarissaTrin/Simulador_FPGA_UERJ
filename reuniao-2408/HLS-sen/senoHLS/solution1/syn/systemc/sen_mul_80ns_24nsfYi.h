...
// ==============================================================
#ifndef __sen_mul_80ns_24nsfYi__HH__
#define __sen_mul_80ns_24nsfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sen_mul_80ns_24nsfYi) {
    ...
    SC_CTOR(sen_mul_80ns_24nsfYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
