...
// ==============================================================
#ifndef __sen_ref_4oPi_tablbkb_H__
#define __sen_ref_4oPi_tablbkb_H__
...
struct sen_ref_4oPi_tablbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sen_ref_4oPi_tablbkb_ram) {
...
SC_MODULE(sen_ref_4oPi_tablbkb) {
...
sen_ref_4oPi_tablbkb_ram* meminst;


SC_CTOR(sen_ref_4oPi_tablbkb) {
meminst = new sen_ref_4oPi_tablbkb_ram("sen_ref_4oPi_tablbkb_ram");
